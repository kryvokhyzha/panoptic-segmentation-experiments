...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=str,
        help=(
            "Config or checkpoint .pth file or the model name "
    ...
    parser.add_argument(
        "--out-dir", type=str, default="outputs", help="Output directory of images or prediction results."
    )
    ...
    parser.add_argument(
        ...
        action="store_true",
        help=(
            "Whether to customize entity names? "
